...
import {
  Sparkles, ChevronDown, TrendingUp, Key, Layers,
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="px-6 pt-24 pb-32 max-w-7xl mx-auto text-center">
        ...
        <p className="animate-fade-in-up text-lg md:text-xl text-gray-600 mb-8 max-w-2xl mx-auto"
          ...
          Residential homes, carpet steam cleaning, pre-sale presentations and end of lease. Pristine delivers across all of Hobart and Greater Tasmania.
        </p>
        ...
        <div className="animate-fade-in-up mt-16 flex flex-wrap items-center justify-center gap-8"
          ...
          {['Homeowners', 'Property Developers', 'Real Estate Agencies', 'Tenants & Renters'].map(n => (
      ...
      <footer className="py-12 px-6 border-t border-gray-100">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start justify-between gap-12">
          <div className="max-w-xs">
            ...
            <p className="text-sm text-gray-500 leading-relaxed">Hobart's premium cleaning service for residential homes, pre-sale presentations, and end of lease properties across Tasmania.</p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 text-sm">
            <div>
              ...
              <ul className="space-y-2 text-gray-500">
                {['Residential Cleaning', 'Carpet Steam Cleaning', 'Pre-Sale Clean', 'End of Lease'].map(s => (
