        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
            <div className="flex flex-col sm:flex-row gap-4">
              <button onClick={open} className="bg-white text-black px-8 py-3.5 rounded-full font-medium hover:bg-gray-100 transition-colors">
                Get Free Quote
              </button>
              <a href="tel:0450349425" className="border border-gray-700 text-white px-8 py-3.5 rounded-full font-medium hover:border-gray-500 transition-colors text-center">
                Call 0450 349 425
              </a>
            </div>
